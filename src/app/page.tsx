  ...
  return (
    <div className="relative bg-black min-h-screen overflow-x-hidden">
      ...
      <main>
        ...
        {/* SECCIÓN HISTORIA */}
        <section id="historia" className="relative py-20 sm:py-24 md:py-32 lg:py-48 px-4 sm:px-6 bg-zinc-950">
              ...
              <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8">
                ...
                >
                  ...
                  <div className="space-y-4">
                    <h2 className="font-signature text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-white leading-[1.1] drop-shadow-md">
                      "No heredé una empresa, heredé el pulso de este río. Mi firma es el compromiso de mostrarte su alma."
                    </h2>
                  </div>
                  
                  <div className="space-y-4 sm:space-y-6 text-zinc-400 text-sm sm:text-base lg:text-lg font-light leading-relaxed">
                    <p>
                    ...
                    <div className="pt-6 sm:pt-8 flex items-end gap-4 sm:gap-6 border-t border-white/5">
                      <div className="flex flex-col">
                        ...
                        <span className="font-signature text-3xl sm:text-4xl lg:text-5xl text-gold pb-2">
                          Capitán Jonco
                        </span>
                      </div>
                    </div>
